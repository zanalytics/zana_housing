...
price_paid_url = "http://prod2.publicdata.landregistry.gov.uk.s3-website"\
...
hpi_url = "http://publicdata.landregistry.gov.uk/market-trend-data/"\
          "house-price-index-data/Average-prices-Property-Type-2020-11.csv?"\
