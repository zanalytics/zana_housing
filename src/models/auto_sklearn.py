...
automl.fit(X_train, y_train, dataset_name='housing')
...
print('Mean Absolute Error/Mean :', (metrics.mean_absolute_error(y_test, predictions) / df["adjusted_price"].mean() * 100),
      '%')
